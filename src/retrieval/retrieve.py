...
def expand_retrieval_query(query: str) -> str:
    ...
    if "processed foods" in q or "processed food" in q:
        expansions.append(
            "processed foods ultra-processed foods refined grains added sugar sodium minimally processed foods"
        )
...
def retrieve_chunks(
    ...
    try:
        ...
        raise RetrievalError(f"768 EmbeddingGemma retrieval failed: {exc}") from exc
